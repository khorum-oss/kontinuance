...
import org.khorum.oss.kontinuance.server.config.ConfigResponse
import org.khorum.oss.kontinuance.server.config.PlanSummary
import org.khorum.oss.kontinuance.server.coverage.CoverageMetric
import org.khorum.oss.kontinuance.server.coverage.CoverageModule
import org.khorum.oss.kontinuance.server.coverage.CoverageResponse
import org.khorum.oss.kontinuance.server.pipeline.PipelineResponse
import org.khorum.oss.kontinuance.server.pipeline.PipelineStage
import org.khorum.oss.kontinuance.server.pipeline.PipelineTask
 ...
 * ([org.khorum.oss.kontinuance.server.deploy.DeployController]) and has no fixture. Returns typed DTOs
