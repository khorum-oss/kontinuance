package org.khorum.oss.kontinuance.server.socket
...
/**
 * WebFlux WebSocket endpoint (`/ws/runs`, wired in [org.khorum.oss.kontinuance.server.config.WebSocketConfig])
 * pushing run records as text frames
